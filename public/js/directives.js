...
function SideScroll(selector) {
  ...
  return {
    require: 'ngModel',
    templateUrl: '/views/templates/articles.scroll.html',
    scope: {
      'ngModel': '='
    },
...
app.directive('bhoriscroller', function uiJqInjectingFunction(){
...
function SideScroll(selector) {
  ...
  return {
    require: 'ngModel',
    templateUrl: '/views/templates/books.scroll.html',
    scope: {
      'ngModel': '='
    },
    compile: function uiJqCompilingFunction($templateElement, $templateAttribute) {
...
app.directive('phoriscroller', function uiJqInjectingFunction(){
...
function SideScroll(selector) {
  ...
  return {
    require: 'ngModel',
    templateUrl: '/views/templates/profile.scroll.html',
    scope: {
      'ngModel': '='
    },
    compile: function uiJqCompilingFunction($templateElement, $templateAttribute) {
...
app.directive('vhoriscroller', function uiJqInjectingFunction(){
...
function SideScroll(selector) {
  ...
  return {
    require: 'ngModel',
    templateUrl: '/views/templates/videos.scroll.html',
    scope: {
      'ngModel': '='
    },
    compile: function uiJqCompilingFunction($templateElement, $templateAttribute) {
